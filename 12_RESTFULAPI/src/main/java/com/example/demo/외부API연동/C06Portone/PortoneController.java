...
public class PortoneController {
    ...
    @Value("${portone_key}")
    String IMP_KEY; //REST API KEY
    @Value("${portone_secret}")
    String IMP_SECRET; //REST API SECRET
...
//        header.add("Content-Type","application/x-www-form-urlencoded;charset=utf-8");
    ...
    @ResponseBody
    public ResponseEntity<CertificationResponse> certifications(@PathVariable String imp_uid){
...
//        MultiValueMap<String,String> params = new LinkedMultiValueMap<>();
        ...
        params.put("merchant_uid","test_merchand1781501553352");
